...
const FAIL_INPUT_NO_FOREGROUND: i32 = 27401
const FAIL_INPUT_STAGE0: i32 = 27402
const FAIL_INPUT_STAGE1: i32 = 27403
const FAIL_INPUT_STAGE2: i32 = 27404
const FAIL_INPUT_MANIFEST: i32 = 27405
const FAIL_INPUT_APPLY_SCHEDULE: i32 = 27406
const FAIL_INPUT_APPLY_WAITING: i32 = 27407
const FAIL_INPUT_APPLY_DONE: i32 = 27408
const FAIL_INPUT_SELECT: i32 = 27409
const FAIL_INPUT_LAUNCH: i32 = 27410
const FAIL_INPUT_FOREGROUND: i32 = 27411
const FAIL_INPUT_DELIVERED: i32 = 27412
...
func run_input_event_probe() i32 {
    ...
    if !expect_reply(effect, syscall.SyscallStatus.Ok, 4, 0, input_event.INPUT_ROUTE_NO_FOREGROUND, input_event.INPUT_EVENT_KEY, 65) {
        return FAIL_INPUT_NO_FOREGROUND
    }
    ...
    if service_effect.effect_reply_status(effect) != syscall.SyscallStatus.Ok || service_effect.effect_reply_payload_len(effect) != 2 {
        return FAIL_INPUT_APPLY_SCHEDULE
    }
    ...
    if !expect_workflow(effect, syscall.SyscallStatus.Ok, workflow_core.WORKFLOW_STATE_WAITING, workflow_core.WORKFLOW_RESTART_NONE) {
        return FAIL_INPUT_APPLY_WAITING
    }
    effect = kernel_dispatch.kernel_dispatch_step(&state, scenario_transport.cmd_workflow_query(apply_id))
