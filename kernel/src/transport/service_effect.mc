...
func message(source_pid: u32, endpoint_id: u32, payload_len: usize, payload: [4]u8) Message {
    return Message{ source_pid: source_pid, endpoint_id: endpoint_id, payload_len: payload_len, received_handle_slot: 0, received_handle_count: 0, received_endpoint_id: 0, received_endpoint_id_1: 0, payload: payload }
}

func message_with_handle(source_pid: u32, endpoint_id: u32, payload_len: usize, payload: [4]u8, received_handle_slot: u32, received_handle_count: usize, received_endpoint_id: u32, received_endpoint_id_1: u32) Message {
    return Message{ source_pid: source_pid, endpoint_id: endpoint_id, payload_len: payload_len, received_handle_slot: received_handle_slot, received_handle_count: received_handle_count, received_endpoint_id: received_endpoint_id, received_endpoint_id_1: received_endpoint_id_1, payload: payload }
}
...
func from_receive_observation(obs: syscall.ReceiveObservation) Message {
    return message_with_handle(obs.source_pid, obs.endpoint_id, obs.payload_len, obs.payload, obs.received_handle_slot, obs.received_handle_count, 0, 0)
}