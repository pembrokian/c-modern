...
- admitted service-layer boundary: shared service_effect Message and Effect contract; log_service, kv_service, queue_service, ticket_service, journal_service as one bounded durable replay owner, object_store_service as one bounded durable named-object owner, update_store_service as one bounded staged-update owner, shell_service with compact hostile-user invalid classification (`?C`, `?S`), serial_service, echo_service, and transfer_service
