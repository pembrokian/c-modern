...
- admitted topology boundary: service_topology.mc owns SERIAL, SHELL, LOG, KV, and ECHO endpoint constants plus flat lookup helpers; shell_service.mc is topology-neutral
...
- admitted proof set: Phases 109–179 (see `docs/plan/admin/veya_running_system_support_statement.txt` for the full list)
