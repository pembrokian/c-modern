...
- admitted topology boundary: service_topology.mc owns SERIAL, SHELL, LOG, KV, ECHO, TRANSFER, QUEUE, TICKET, JOURNAL, OBJECT_STORE, WORKFLOW, COMPLETION_MAILBOX, LEASE, CONNECTION, and UPDATE_STORE endpoint constants plus flat lookup helpers and static restart classification; shell_service.mc is topology-neutral
