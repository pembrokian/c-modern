...
- `stdlib/`: standard library modules; `stdlib/mem.mc` now owns the admitted fixed-size `mem.Pool` byte-slot contract from Phase 262 and the explicit `Arena` init/reset/new/deinit scratch-work contract landed in Phase 263
