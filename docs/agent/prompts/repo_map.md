...
- `kernel/`: repository-owned Canopus kernel bring-up tree; currently a Phase 121 kernel image-contract-hardening target
- `kernel/`: repository-owned Canopus kernel bring-up tree; currently a Phase 120 running-system-support kernel target
