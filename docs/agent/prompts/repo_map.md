...
- `kernel/`: repository-owned Canopus kernel bring-up tree; currently a Phase 105 real log-service handshake kernel target
...
- `tests/tool`
  ...
  - grouped tool coverage now lives in:
    ...
    - `tests/tool/freestanding/kernel/phase85_endpoint_queue.cpp`, `phase86_task_lifecycle.cpp`, `phase87_static_data.cpp`, `phase88_build_integration.cpp`, `phase97_user_entry.cpp`, `phase98_endpoint_handle_core.cpp`, `phase103_init_bootstrap_handoff.cpp`, `phase105_real_log_service_handshake.cpp`: one kernel proof per file
