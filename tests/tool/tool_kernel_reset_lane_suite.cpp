...
constexpr std::array<ResetLaneScenario, 82> kResetLaneScenarios = {{
    ...
    {.label = "install slot", .fixture_relative_path = "tests/system/kernel_reset_lane_phase269_install_slot", .scenario_key = "phase269_install_slot", .context_label = "phase 269 install slot", .target_name = "app", .include_in_fast = true, .build_warn_ms = 1000},
    {.label = "app restart truth", .fixture_relative_path = "tests/system/kernel_reset_lane_phase270_app_restart_truth", .scenario_key = "phase270_app_restart_truth", .context_label = "phase 270 app restart truth", .target_name = "app", .include_in_fast = true, .build_warn_ms = 1000},
    {.label = "app manifest", .fixture_relative_path = "tests/system/kernel_reset_lane_phase271_app_manifest", .scenario_key = "phase271_app_manifest", .context_label = "phase 271 app manifest", .target_name = "app", .include_in_fast = true, .build_warn_ms = 1000},
    {.label = "installed workflow demo", .fixture_relative_path = "tests/system/kernel_reset_lane_phase272_installed_workflow_demo", .scenario_key = "phase272_installed_workflow_demo", .context_label = "phase 272 installed workflow demo", .target_name = "app", .include_in_fast = true, .build_warn_ms = 1000},
    ...
    {.label = "review_board foreground interaction", .fixture_relative_path = "tests/system/kernel_reset_lane_phase295_review_board_foreground_interaction_follow_through", .scenario_key = "phase295_review_board_foreground_interaction_follow_through", .context_label = "phase 295 review_board foreground interaction", .target_name = "app", .include_in_fast = true, .build_warn_ms = 1000},
    ...
    {.label = "integrated small system demo", .fixture_relative_path = "tests/system/kernel_reset_lane_phase290_integrated_small_user_facing_system_demo", .scenario_key = "phase290_integrated_small_user_facing_system_demo", .context_label = "phase 290 integrated small system demo", .target_name = "app", .include_in_fast = true, .build_warn_ms = 1000},
