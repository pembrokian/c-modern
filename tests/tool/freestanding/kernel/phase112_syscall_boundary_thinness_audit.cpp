...
void ExpectPhase112MirStructureSlice(const std::filesystem::path& mir_path,
    ...
    ExpectMirFirstMatchProjectionFile(
        kernel_mir,
        {
            ...
            "target=address_space.build_child_bootstrap_context target_kind=function target_name=address_space.build_child_bootstrap_context",
            "target=capability.resolve_endpoint_handle target_kind=function target_name=capability.resolve_endpoint_handle",
            "target=endpoint.build_runtime_message target_kind=function target_name=endpoint.build_runtime_message",
            "target=endpoint.enqueue_runtime_message target_kind=function target_name=endpoint.enqueue_runtime_message",
            "target=endpoint.receive_runtime_message target_kind=function target_name=endpoint.receive_runtime_message",
        },
