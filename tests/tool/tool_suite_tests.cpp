...
#if defined(MC_TOOL_WORKFLOW_MAIN)
    RunPhase7WorkflowSuite(source_root, binary_root, mc_path);
#elif defined(MC_TOOL_BUILD_STATE_MAIN)
    RunPhase7BuildStateSuite(binary_root, mc_path);
#elif defined(MC_TOOL_REAL_PROJECTS_MAIN)
    RunPhase7RealProjectSuite(source_root, binary_root, mc_path);
#elif defined(MC_TOOL_FREESTANDING_MAIN)
    RunPhase7FreestandingSuite(source_root, binary_root, mc_path);
#else
    RunPhase7WorkflowSuite(source_root, binary_root, mc_path);
    RunPhase7BuildStateSuite(binary_root, mc_path);
    RunPhase7RealProjectSuite(source_root, binary_root, mc_path);
