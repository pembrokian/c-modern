...
struct Phase149RestartSemanticsFirstClassPatternAudit {
    phase148: Phase148AuthorityErgonomicsAudit
    shell_service_pid: u32
    kv_service_pid: u32
    log_service_pid: u32
    init_policy_owner_pid: u32
...
struct Phase150OneSystemRebuiltCleanlyAudit {
    phase149: Phase149RestartSemanticsFirstClassPatternAudit
    serial_service_pid: u32
    shell_service_pid: u32
    log_service_pid: u32
    kv_service_pid: u32
...
struct Phase152PatternStabilityAudit {
    phase150: Phase150OneSystemRebuiltCleanlyAudit
    serial_service_pid: u32
    shell_service_pid: u32
    log_service_pid: u32
    kv_service_pid: u32
    pre_restart_log_append_route: shell_service.ShellRoutingObservation
    pre_restart_log_tail_route: shell_service.ShellRoutingObservation
    pre_restart_kv_set_route: shell_service.ShellRoutingObservation
    pre_restart_kv_get_route: shell_service.ShellRoutingObservation
    post_restart_log_tail_route: shell_service.ShellRoutingObservation
    post_restart_kv_get_route: shell_service.ShellRoutingObservation
    pre_restart_log_retention: log_service.LogRetentionObservation
    post_restart_log_retention: log_service.LogRetentionObservation
    post_restart_kv_retention: kv_service.KvRetentionObservation
    restart: init.ServiceRestartObservation
    rebuilt_system_helper_survives_visible: u32
    shell_command_shape_survives_visible: u32
    unaffected_peer_state_survives_visible: u32
    restarted_service_state_resets_visible: u32
    restart_evidence_moves_outside_restarted_owner_visible: u32
    partial_generalization_visible: u32
    full_generalization_visible: u32
    pattern_failure_visible: u32
    dynamic_service_framework_visible: u32
    compiler_reopening_visible: u32
}

func empty_running_kernel_slice_audit() RunningKernelSliceAudit {
    return RunningKernelSliceAudit{ kernel: state.empty_descriptor(), init_pid: 0, init_tid: 0, init_asid: 0, child_tid: 0, child_exit_code: 0, transfer_endpoint_id: 0, log_service_request_byte: 0, echo_service_request_byte0: 0, echo_service_request_byte1: 0, log_service_exit_code: 0, echo_service_exit_code: 0, transfer_service_exit_code: 0, init_bootstrap_handoff: init.BootstrapHandoffObservation{ owner_pid: 0, authority_count: 0, endpoint_handle_slot: 0, program_capability_slot: 0, program_object_id: 0, ambient_root_visible: 0 }, receive_observation: syscall.empty_receive_observation(), attached_receive_observation: syscall.empty_receive_observation(), transferred_handle_use_observation: syscall.empty_receive_observation(), pre_exit_wait_observation: syscall.empty_wait_observation(), exit_wait_observation: syscall.empty_wait_observation(), sleep_observation: syscall.empty_sleep_observation(), timer_wake_observation: timer.TimerWakeObservation{ task_id: 0, deadline_tick: 0, wake_tick: 0, wake_count: 0 }, log_service_handshake: log_service.LogHandshakeObservation{ service_pid: 0, client_pid: 0, endpoint_id: 0, tag: log_service.LogMessageTag.None, request_len: 0, request_byte: 0, ack_byte: 0, request_count: 0, ack_count: 0 }, log_service_wait_observation: syscall.empty_wait_observation(), echo_service_exchange: echo_service.EchoExchangeObservation{ service_pid: 0, client_pid: 0, endpoint_id: 0, tag: echo_service.EchoMessageTag.None, request_len: 0, request_byte0: 0, request_byte1: 0, reply_len: 0, reply_byte0: 0, reply_byte1: 0, request_count: 0, reply_count: 0 }, echo_service_wait_observation: syscall.empty_wait_observation(), transfer_service_transfer: transfer_service.TransferObservation{ service_pid: 0, client_pid: 0, control_endpoint_id: 0, transferred_endpoint_id: 0, transferred_rights: 0, tag: transfer_service.CapabilityTransferTag.None, grant_len: 0, grant_byte0: 0, grant_byte1: 0, grant_byte2: 0, grant_byte3: 0, emit_len: 0, emit_byte0: 0, emit_byte1: 0, emit_byte2: 0, emit_byte3: 0, grant_count: 0, emit_count: 0 }, transfer_service_wait_observation: syscall.empty_wait_observation(), phase104_contract_hardened: 0, phase108_contract_hardened: 0, init_process: state.empty_process_slot(), init_task: state.empty_task_slot(), init_user_frame: address_space.empty_frame(), boot_log_append_failed: 0 }
}

func empty_phase117_multi_service_bring_up_audit() Phase117MultiServiceBringUpAudit {
    running_slice: RunningKernelSliceAudit = empty_running_kernel_slice_audit()
    return Phase117MultiServiceBringUpAudit{ running_slice: running_slice, init_endpoint_id: 0, transfer_endpoint_id: 0, log_service_program_capability: capability.empty_slot(), echo_service_program_capability: capability.empty_slot(), transfer_service_program_capability: capability.empty_slot(), log_service_spawn: syscall.empty_spawn_observation(), echo_service_spawn: syscall.empty_spawn_observation(), transfer_service_spawn: syscall.empty_spawn_observation(), log_service_wait: syscall.empty_wait_observation(), echo_service_wait: syscall.empty_wait_observation(), transfer_service_wait: syscall.empty_wait_observation(), log_service_handshake: log_service.LogHandshakeObservation{ service_pid: 0, client_pid: 0, endpoint_id: 0, tag: log_service.LogMessageTag.None, request_len: 0, request_byte: 0, ack_byte: 0, request_count: 0, ack_count: 0 }, echo_service_exchange: echo_service.EchoExchangeObservation{ service_pid: 0, client_pid: 0, endpoint_id: 0, tag: echo_service.EchoMessageTag.None, request_len: 0, request_byte0: 0, request_byte1: 0, reply_len: 0, reply_byte0: 0, reply_byte1: 0, request_count: 0, reply_count: 0 }, transfer_service_transfer: transfer_service.TransferObservation{ service_pid: 0, client_pid: 0, control_endpoint_id: 0, transferred_endpoint_id: 0, transferred_rights: 0, tag: transfer_service.CapabilityTransferTag.None, grant_len: 0, grant_byte0: 0, grant_byte1: 0, grant_byte2: 0, grant_byte3: 0, emit_len: 0, emit_byte0: 0, emit_byte1: 0, emit_byte2: 0, emit_byte3: 0, grant_count: 0, emit_count: 0 } }
}

func empty_phase118_delegated_request_reply_audit() Phase118DelegatedRequestReplyAudit {
    phase117: Phase117MultiServiceBringUpAudit = empty_phase117_multi_service_bring_up_audit()
    return Phase118DelegatedRequestReplyAudit{ phase117: phase117, transfer_service_transfer: transfer_service.TransferObservation{ service_pid: 0, client_pid: 0, control_endpoint_id: 0, transferred_endpoint_id: 0, transferred_rights: 0, tag: transfer_service.CapabilityTransferTag.None, grant_len: 0, grant_byte0: 0, grant_byte1: 0, grant_byte2: 0, grant_byte3: 0, emit_len: 0, emit_byte0: 0, emit_byte1: 0, emit_byte2: 0, emit_byte3: 0, grant_count: 0, emit_count: 0 }, invalidated_source_send_status: syscall.SyscallStatus.None, invalidated_source_handle_slot: 0, retained_receive_handle_slot: 0, retained_receive_endpoint_id: 0 }
}

func empty_phase119_namespace_pressure_audit() Phase119NamespacePressureAudit {
    phase118: Phase118DelegatedRequestReplyAudit = empty_phase118_delegated_request_reply_audit()
    return Phase119NamespacePressureAudit{ phase118: phase118, directory_owner_pid: 0, directory_entry_count: 0, log_service_key: 0, echo_service_key: 0, transfer_service_key: 0, shared_directory_endpoint_id: 0, log_service_program_slot: 0, echo_service_program_slot: 0, transfer_service_program_slot: 0, log_service_program_object_id: 0, echo_service_program_object_id: 0, transfer_service_program_object_id: 0, log_service_wait_handle_slot: 0, echo_service_wait_handle_slot: 0, transfer_service_wait_handle_slot: 0, dynamic_namespace_visible: 0 }
}

func empty_phase120_running_system_support_audit() Phase120RunningSystemSupportAudit {
    phase119: Phase119NamespacePressureAudit = empty_phase119_namespace_pressure_audit()
    return Phase120RunningSystemSupportAudit{ phase119: phase119, service_policy_owner_pid: 0, running_service_count: 0, fixed_directory_count: 0, shared_control_endpoint_id: 0, retained_reply_endpoint_id: 0, program_capability_count: 0, wait_handle_count: 0, dynamic_loading_visible: 0, service_manager_visible: 0, dynamic_namespace_visible: 0 }
}

func empty_phase121_kernel_image_contract_audit() Phase121KernelImageContractAudit {
    phase120: Phase120RunningSystemSupportAudit = empty_phase120_running_system_support_audit()
    return Phase121KernelImageContractAudit{ phase120: phase120, kernel_manifest_visible: 0, kernel_target_visible: 0, kernel_runtime_startup_visible: 0, bootstrap_target_family_visible: 0, emitted_image_input_visible: 0, linked_kernel_executable_visible: 0, dynamic_loading_visible: 0, service_manager_visible: 0, dynamic_namespace_visible: 0 }
}

func empty_phase122_target_surface_audit() Phase122TargetSurfaceAudit {
    phase121: Phase121KernelImageContractAudit = empty_phase121_kernel_image_contract_audit()
    return Phase122TargetSurfaceAudit{ phase121: phase121, kernel_target_visible: 0, kernel_runtime_startup_visible: 0, bootstrap_target_family_visible: 0, bootstrap_target_family_only_visible: 0, broader_target_family_visible: 0, dynamic_loading_visible: 0, service_manager_visible: 0, dynamic_namespace_visible: 0 }
}

func empty_phase123_next_plateau_audit() Phase123NextPlateauAudit {
    phase122: Phase122TargetSurfaceAudit = empty_phase122_target_surface_audit()
    return Phase123NextPlateauAudit{ phase122: phase122, running_kernel_truth_visible: 0, running_system_truth_visible: 0, kernel_image_truth_visible: 0, target_surface_truth_visible: 0, broader_platform_visible: 0, broad_target_support_visible: 0, general_loading_visible: 0, compiler_reopening_visible: 0 }
}

func empty_phase124_delegation_chain_audit() Phase124DelegationChainAudit {
    phase123: Phase123NextPlateauAudit = empty_phase123_next_plateau_audit()
    return Phase124DelegationChainAudit{ phase123: phase123, delegator_pid: 0, intermediary_pid: 0, final_holder_pid: 0, control_endpoint_id: 0, delegated_endpoint_id: 0, delegator_source_handle_slot: 0, intermediary_receive_handle_slot: 0, final_receive_handle_slot: 0, first_invalidated_send_status: syscall.SyscallStatus.None, second_invalidated_send_status: syscall.SyscallStatus.None, final_send_status: syscall.SyscallStatus.None, final_send_source_pid: 0, final_endpoint_queue_depth: 0, ambient_authority_visible: 0, compiler_reopening_visible: 0 }
}

func empty_phase125_invalidation_audit() Phase125InvalidationAudit {
    phase124: Phase124DelegationChainAudit = empty_phase124_delegation_chain_audit()
    return Phase125InvalidationAudit{ phase124: phase124, invalidated_holder_pid: 0, control_endpoint_id: 0, invalidated_endpoint_id: 0, invalidated_handle_slot: 0, rejected_send_status: syscall.SyscallStatus.None, rejected_receive_status: syscall.SyscallStatus.None, surviving_control_send_status: syscall.SyscallStatus.None, surviving_control_source_pid: 0, surviving_control_queue_depth: 0, authority_loss_visible: 0, broader_revocation_visible: 0, compiler_reopening_visible: 0 }
}

func empty_phase126_authority_lifetime_audit() Phase126AuthorityLifetimeAudit {
    phase125: Phase125InvalidationAudit = empty_phase125_invalidation_audit()
    return Phase126AuthorityLifetimeAudit{ phase125: phase125, classified_holder_pid: 0, long_lived_endpoint_id: 0, short_lived_endpoint_id: 0, long_lived_handle_slot: 0, short_lived_handle_slot: 0, repeat_long_lived_send_status: syscall.SyscallStatus.None, repeat_long_lived_source_pid: 0, repeat_long_lived_queue_depth: 0, long_lived_class_visible: 0, short_lived_class_visible: 0, broader_lifetime_framework_visible: 0, compiler_reopening_visible: 0 }
}

func empty_phase128_service_death_observation_audit() Phase128ServiceDeathObservationAudit {
    phase126: Phase126AuthorityLifetimeAudit = empty_phase126_authority_lifetime_audit()
    return Phase128ServiceDeathObservationAudit{ phase126: phase126, observed_service_pid: 0, observed_service_key: 0, observed_wait_handle_slot: 0, observed_exit_code: 0, fixed_directory_entry_count: 0, service_death_visible: 0, kernel_supervision_visible: 0, service_restart_visible: 0, broader_failure_framework_visible: 0, compiler_reopening_visible: 0 }
}

func empty_phase129_partial_failure_propagation_audit() Phase129PartialFailurePropagationAudit {
    phase128: Phase128ServiceDeathObservationAudit = empty_phase128_service_death_observation_audit()
    return Phase129PartialFailurePropagationAudit{ phase128: phase128, failed_service_pid: 0, failed_service_key: 0, failed_wait_handle_slot: 0, failed_wait_status: syscall.SyscallStatus.None, surviving_service_pid: 0, surviving_service_key: 0, surviving_wait_handle_slot: 0, surviving_reply_status: syscall.SyscallStatus.None, surviving_wait_status: syscall.SyscallStatus.None, surviving_reply_byte0: 0, surviving_reply_byte1: 0, shared_control_endpoint_id: 0, directory_entry_count: 0, partial_failure_visible: 0, kernel_recovery_visible: 0, service_rebinding_visible: 0, broader_failure_framework_visible: 0, compiler_reopening_visible: 0 }
}

func empty_phase130_explicit_restart_audit() Phase130ExplicitRestartOrReplacementAudit {
    phase129: Phase129PartialFailurePropagationAudit = empty_phase129_partial_failure_propagation_audit()
    return Phase130ExplicitRestartOrReplacementAudit{ phase129: phase129, replacement_policy_owner_pid: 0, replacement_service_pid: 0, replacement_service_key: 0, replacement_wait_handle_slot: 0, replacement_program_slot: 0, replacement_program_object_id: 0, replacement_spawn_status: syscall.SyscallStatus.None, replacement_ack_status: syscall.SyscallStatus.None, replacement_wait_status: syscall.SyscallStatus.None, replacement_ack_byte: 0, shared_control_endpoint_id: 0, directory_entry_count: 0, explicit_restart_or_replacement_visible: 0, kernel_supervision_visible: 0, service_rebinding_visible: 0, broader_failure_framework_visible: 0, compiler_reopening_visible: 0 }
}

func empty_phase131_fan_out_composition_audit() Phase131FanOutCompositionAudit {
    phase130: Phase130ExplicitRestartOrReplacementAudit = empty_phase130_explicit_restart_audit()
    return Phase131FanOutCompositionAudit{ phase130: phase130, composition_policy_owner_pid: 0, composition_service_pid: 0, composition_service_key: 0, composition_wait_handle_slot: 0, fixed_directory_entry_count: 0, control_endpoint_id: 0, echo_endpoint_id: 0, log_endpoint_id: 0, request_receive_status: syscall.SyscallStatus.None, echo_fanout_status: syscall.SyscallStatus.None, echo_fanout_endpoint_id: 0, log_fanout_status: syscall.SyscallStatus.None, log_fanout_endpoint_id: 0, echo_reply_status: syscall.SyscallStatus.None, log_ack_status: syscall.SyscallStatus.None, aggregate_reply_status: syscall.SyscallStatus.None, composition_wait_status: syscall.SyscallStatus.None, aggregate_reply_byte0: 0, aggregate_reply_byte1: 0, aggregate_reply_byte2: 0, aggregate_reply_byte3: 0, explicit_composition_visible: 0, kernel_broker_visible: 0, dynamic_namespace_visible: 0, compiler_reopening_visible: 0 }
}

func empty_phase136_device_failure_containment_audit() Phase136DeviceFailureContainmentAudit {
    phase131: Phase131FanOutCompositionAudit = empty_phase131_fan_out_composition_audit()
    return Phase136DeviceFailureContainmentAudit{ phase131: phase131, uart_service_endpoint_id: 0, malformed_interrupt_kind: interrupt.InterruptDispatchKind.None, malformed_dispatch_handled: 0, malformed_published_queued: 0, malformed_published_queue_full: 0, malformed_published_endpoint_valid: 0, malformed_published_endpoint_closed: 0, malformed_serial_service_pid: 0, malformed_serial_tag: serial_service.empty_serial_message_tag(), malformed_receive_status: syscall.SyscallStatus.None, malformed_payload_len: 0, malformed_received_byte: 0, malformed_ingress_count: 0, malformed_service_malformed_count: 0, malformed_log_len: 0, malformed_total_consumed_bytes: 0, queue_one_published_queued: 0, queue_two_published_queued: 0, queue_full_dispatch_handled: 0, queue_full_published_queued: 0, queue_full_published_queue_full: 0, queue_full_published_endpoint_valid: 0, queue_full_published_endpoint_closed: 0, queue_full_drop_count: 0, queue_full_failure_kind: uart.UartFailureKind.None, uart_ack_count_after_queue_full: 0, uart_ingress_count_after_queue_full: 0, uart_retire_count_after_queue_full: 0, close_endpoint_id: 0, close_closed: 0, close_aborted_messages: 0, close_wake_count: 0, close_wait_status: syscall.SyscallStatus.None, closed_dispatch_handled: 0, closed_published_queued: 0, closed_published_queue_full: 0, closed_published_endpoint_valid: 0, closed_published_endpoint_closed: 0, closed_drop_count: 0, closed_endpoint_closed_drop_count: 0, closed_failure_kind: uart.UartFailureKind.None, kernel_policy_visible: 0, driver_framework_visible: 0, retry_framework_visible: 0, protocol_parsing_in_kernel_visible: 0, compiler_reopening_visible: 0 }
}

func empty_phase137_optional_dma_audit() Phase137OptionalDmaOrEquivalentAudit {
    phase136: Phase136DeviceFailureContainmentAudit = empty_phase136_device_failure_containment_audit()
    return Phase137OptionalDmaOrEquivalentAudit{ phase136: phase136, completion_interrupt_kind: interrupt.InterruptDispatchKind.None, completion_dispatch_handled: 0, completion_endpoint_id: 0, completion_staged_payload_len: 0, completion_staged_payload0: 0, completion_staged_payload1: 0, completion_staged_payload2: 0, completion_staged_payload3: 0, completion_published_payload_len: 0, completion_published_payload0: 0, completion_published_payload1: 0, completion_published_payload2: 0, completion_published_payload3: 0, completion_retired_payload_len: 0, completion_retired_payload0: 0, completion_retired_payload1: 0, completion_retired_payload2: 0, completion_retired_payload3: 0, completion_publish_queued: 0, completion_publish_queue_full: 0, completion_publish_endpoint_valid: 0, completion_publish_endpoint_closed: 0, completion_ingress_count: 0, completion_retire_count: 0, serial_service_pid: 0, serial_receive_status: syscall.SyscallStatus.None, serial_tag: serial_service.empty_serial_message_tag(), serial_payload_len: 0, serial_received_byte: 0, serial_ingress_count: 0, serial_log_len: 0, serial_total_consumed_bytes: 0, serial_log_byte0: 0, serial_log_byte1: 0, serial_log_byte2: 0, serial_log_byte3: 0, dma_manager_visible: 0, descriptor_framework_visible: 0, compiler_reopening_visible: 0 }
}
